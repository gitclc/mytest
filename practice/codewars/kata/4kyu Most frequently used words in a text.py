...
#     a = Counter([i.lower() for i in re.findall("[a-zA-Z']+", text) if not (len(set(i)) == 1 and "'" in set(i))])
#     return sorted(a, key=lambda x: a[x], reverse=True)[0:3]
...
if __name__ == '__main__':
    a = top_3_words("e e e e DDD ddd DdD: ddd ddd aa aA Aa, bb cc cC e e e")
    print(a)
